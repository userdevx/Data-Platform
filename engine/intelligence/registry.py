...
from engine.intelligence.capabilities.builtins import get_capability
...
class AbilityDefinition:
    ...
    @property
    def capability(self):
        return get_capability(self.capability_name)

    def resolve_capability(self, *_args: Any, **_kwargs: Any):
        return get_capability(self.capability_name)
...
class AbilityRegistry:
    def __init__(self) -> None:
        self._abilities = {
            ...
            "search_public_sources": AbilityDefinition(
                ...
                required_tools=("public_source_search",),
            ),
    ...
    def names(self) -> tuple[str, ...]:
        return tuple(self._abilities.keys())

    def all(self) -> dict[str, AbilityDefinition]:
